...
struct ContextInsenAA : public ModulePass {
  static char ID;

  ContextInsenAA() : ModulePass(ID) { }
...
}; // struct ContextInsenAA


char ContextInsenAA::ID = 0;
static RegisterPass<ContextInsenAA> X("contextinsen-aa",
